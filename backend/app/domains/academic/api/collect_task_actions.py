...
# NOTE: the static /tasks/active route MUST stay before /tasks/{task_id} —
# FastAPI matches in registration order, otherwise "active" hits the int
# path converter and 422s.
@router.get(
    "/tasks/active",
